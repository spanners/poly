(define (p+ p1 p2) (simp-terms (simp-vars (append p1 p2)))) (define (p- p1 p2) (p+ p1 (negate-poly p2)))
(define (p* p1 p2) (simp-terms (simp-vars (foldr append '() (cartesian-map term* p1 p2)))))
(define (p= p1 p2) (null? (p- p1 p2))) (define (simp-terms p) (simplify p combine-terms vars= cadr))
(define (simp-vars p)
